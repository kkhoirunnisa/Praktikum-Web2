...
<a class="btn btn-primary mb-2 mt-2" href="tambah_dosen">+ TAMBAH DOSEN</a>
<!--menampilkan tabel-->
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-danger" href="hapus_dosen/<?php echo $x['id']; ?>" onclick="return confirm('Apakah yakin akan menhgapus data ini?')">Hapus</a>
                </td>
            </tr>
        <?php
        }

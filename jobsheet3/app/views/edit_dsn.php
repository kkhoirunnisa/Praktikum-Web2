...
<div class="px-5">
    ...
    <a class="btn btn-success mb-2 mt-2" href="tampil_dsn.php">KEMBALI</a>
     <!-- Container dengan padding horizontal, border, dan lebar 40% -->
    <div class="px-3 border " style="width:40%; ">
    <!-- Form untuk mengupdate data dosen, aksi dikirim sebagai parameter URL -->    
    <form action="proses_dsn.php?aksi=update" method="post">
            ...
            ?>
<!-- Loop untuk mengisi form dengan data dosen yang akan diedit -->
                <!-- mengedit nidn -->
                <div class="mb-3">
    ...
    ?>
        <table>
            <tr>
                <td>NIDN</td>
                <input type="hidden" name="id" value="<?php echo $d['id'] ?>">
                <td><input type="text" name="nidn" value="<?php echo $d['nidn'] ?>"> </td>
            </tr>
            <tr>
                <td>Nama</td>
